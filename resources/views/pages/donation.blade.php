...
<body>
    <div class="container">
        ...
        <h3>1. المقدمة</h3>
        <p>
            نرحب بكم في صفحة الدفع الإلكتروني الخاصة بجمعية [اسم الجمعية]. هذه الصفحة مخصصة لتلقي التبرعات الإلكترونية لدعم أنشطة الجمعية الخيرية. 
        ...
        <p>
            تُطبق هذه الشروط وفقًا للقوانين السارية في [اسم الدولة].
        </p>

        <h3>9. الاتصال بنا</h3>
        <p>
            إذا كان لديك أي استفسار أو شكوى، يرجى الاتصال بنا عبر [رقم الهاتف] أو [البريد الإلكتروني].
        </p>
        ...
        <p class="footer">
            التاريخ: [تاريخ آخر تحديث] <br>
            الجمعية: [اسم الجمعية] <br>
