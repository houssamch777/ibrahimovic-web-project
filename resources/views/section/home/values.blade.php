                        ...
                        <div class="row gutter-30 align-items-center">
                            <div class="col-12 col-lg-8 col-xxl-7">
                                <div class="section__header mb-0">
                                    <span class="sub-title"><i class="icon-donation"></i>ابدأ بتبرعك للأشخاص
                                        المحتاجين</span>
                                    <h2 class="title-animation">مساعدة بعضنا البعض يمكن أن تجعل <span>العالم</span> أفضل
                                    </h2>
                                </div>
                            </div>
                        ...
                        <div class="row gutter-60">
                            <div class="col-12 col-md-6 col-xxl-3">
                                <div class="help-three__single" data-aos="fade-up" data-aos-duration="1000">
                                    ...
                                    <div class="help-three__content">
                                        <p>نؤمن بأهمية بناء مبادرات تدوم طويلًا، وتحقق أثرًا مستدامًا للمجتمع.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-6 col-xxl-3">
                                <div class="help-three__single" data-aos="fade-up" data-aos-duration="1000"
                                    ...
                                    <div class="help-three__content">
                                        <p>تتحقق أهدافنا من خلال العمل الجماعي والتكاتف بين الأفراد والمؤسسات.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-6 col-xxl-3">
                                <div class="help-three__single" data-aos="fade-up" data-aos-duration="1000"
                                    ...
                                    <div class="help-three__content">
                                        <!--<h6>التوزيع والنقل</h6> -->
                                        <p>نلتزم بالشفافية في جميع عملياتنا لضمان بناء الثقة مع المانحين والمستفيدين.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-6 col-xxl-3">
                                <div class="help-three__single" data-aos="fade-up" data-aos-duration="1000"
                                    ...
                                    <div class="help-three__content">
                                        <p>نعمل على دعم الفئات المحتاجة دون تمييز، وتوفير المساعدة اللازمة لتحقيق
                                            العدالة الاجتماعية.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
