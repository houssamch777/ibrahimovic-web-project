...
<section class="contact">
            ...
            <div class="col-12 col-md-10 col-xl-7">
                <div class="contact__content">
                    <div class="section__content" data-aos="fade-up" data-aos-duration="1000">
                        ...
                        <h2 class="title-animation">أرسل لنا <span>رسالة</span>
                            لدعم أنشطتنا الخيرية!
                        </h2>
                    </div>
    ...
    <div class="contact-bg">
        <img src="assets/images/contact/contact-bg.png" alt="خلفية الاتصال" class="parallax-image">
    </div>
    <div class="shape-left" data-aos="fade-down" data-aos-duration="1000" data-aos-delay="300">
        <img src="assets/images/cta/shape-left.png" alt="شكل جمالي" class="base-img">
    </div>
</section>
<!-- ==== / قسم الاتصال ينتهي هنا ==== -->