...
<section class="contact">
            ...
            <div class="col-12 col-md-10 col-xl-7">
                <div class="contact__content">
                    <div class="section__content" data-aos="fade-up" data-aos-duration="1000">
                        <span class="sub-title"><i class="icon-donation"></i>ابدأ التواصل معنا</span>
                        <h2 class="title-animation" style="direction: rtl;text-align: right">أرسل لنا <span>رسالة</span>
                             !
                        </h2>
                    </div>
                    <div class="contact__form cta" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">
                        <form >
                            ...
                            <div class="input-single">
                                <input type="text" name="contact-address" id="contactAddress" placeholder="عنوانك...">
    ...
    <div class="contact-bg">
        <img src="assets/images/contact/contact-bg.png" alt="صورة" class="parallax-image">
    </div>
    <div class="shape-left" data-aos="fade-down" data-aos-duration="1000" data-aos-delay="300">
        <img src="assets/images/cta/shape-left.png" alt="صورة" class="base-img">
    </div>
</section>
<!-- ==== / قسم الاتصال ينتهي ==== -->